...
parser.add_argument('--model', metavar='M', type=str, required=True,
					choices=['TranAD', 'LSTM_AD', 'LSTM_Univariate', 'LSTMAutoencoder', 'USAD', 'MTAD_GAT', 'MSCRED', 'CAE_M', 'GDN', 'GTAD', 'TimesNet', 'MERLIN', 'GRUAutoencoder', 'ConvLSTMAutoencoder', 'ConvGRUAutoencoder', 'ConvLSTMAttentionAutoencoder', 'ConvGRUAttentionAutoencoder'])
